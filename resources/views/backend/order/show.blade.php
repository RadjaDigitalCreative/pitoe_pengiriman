            ...
            @if($order)
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <td>{{ rupiah($order->shipping_amount) }}</td>
                                ...
                                <div class="order-info">
                                    ...
                                    <table class="table">
                                        ...
                                        @php
                                            $total =0;
                                        @endphp
                                        @foreach($order_details as $ami)
                                            <tr>
                                                <td> {{$ami->title}}</td>
                                                <td> {{ rupiah($ami->price)}}</td>
                                                <td> {{$ami->quantity}}</td>
                                                <td> {{ rupiah($ami->quantity * $ami->price)}}</td>
                                            </tr>
                                            <?php $total += ($ami->quantity * $ami->price) ?>
                                        @endforeach
                                        <tr>
                                ...
                                <div class="shipping-info">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>No. Resi</td>
                                            @if($order->resi == NULL)
                                                <form action="{{ route('order.courier', $id) }}" method="post">
                                                    @csrf
                                                    <div class="col-md-5">
                                                        <td><input type="text" class="form-control" name="resi"
                                                                   placeholder="Input Resi"></td>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <td>
