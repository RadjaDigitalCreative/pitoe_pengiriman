...
@section('title','PitoeStore || Halaman Detail Blog')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Blog Sendiri</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i>Dari {{$post->author_info['name']}}</a><a
                                                href="javascript:void(0);"><i class="fa fa-calendar"></i>{{$post->created_at->format('M d, Y')}}</a><a
                                                href="javascript:void(0);"><i class="fa fa-comments"></i>Komentar ({{$post->allComments->count()}})</a></span>
                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group button">
                                                            <button type="submit" class="btn"><span
                                                                    class="comment_btn comment">Kirim Komentar</span><span
                                                                    class="comment_btn reply" style="display: none;">Balas Komentar</span>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            @else
                                <p class="text-center p-5">
                                    Anda harus login terlebih dahulu<a href="{{route('login.form')}}"
                                                                       style="color:rgb(54, 54, 204)">Masuk</a> OR <a
                                        style="color:blue" href="{{route('register.form')}}">Daftar</a>untuk
                                    berkomentar.
                                </p>
