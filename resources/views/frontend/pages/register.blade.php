...
@section('title','PitoStore || Halaman Daftar')
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Namamu<span>*</span></label>
                                        <input type="text" name="name" placeholder="Silahkan Masukkan Nama Anda"
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="email"
                                               placeholder="Silahkan Masukkan Alamat Email Anda" required="required"
                                               value="{{old('email')}}">
                                        @error('email')
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="password"
                                               placeholder="Masukkan Kata Sandi/Password" required="required"
                                               value="{{old('password')}}">
                                        @error('password')
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="password_confirmation"
                                               placeholder="Masukkan Kembali Password Anda" required="required"
