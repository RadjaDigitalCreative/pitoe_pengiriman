                    ...
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="shop-sidebar">
                            ...
                            <div class="single-widget category">
                                <h3 class="title">Semua Kategori</h3>
                    ...
                    <div class="col-lg-9 col-md-8 col-12">
                        ...
                        <div class="row">
                            ...
                            @if(count($products)>0)
                                                ...
                                                <div class="button-head">
                                                    <div class="product-action">
                                                        <a data-toggle="modal" data-target="#{{$product->id}}"
                                                           title="Lihat Sekilas" href="#"><i class=" ti-eye"></i><span>Belanja</span></a>
                                                        <a title="Wishlist"
                                ...
                                @endforeach
                            @else
                                <h4 class="text-warning" style="margin:100px auto;">Tidak Ada Produk Apapun.</h4>
                            @endif
