                ...
                <div class="col-12">
                    ...
                    <table class="table shopping-summery">
                        ...
                        <tr class="main-hading">
                            <th>PRODUK</th>
                            <th>NAMA</th>
                            <th class="text-center">UNIT HARGA</th>
                            ...
                            @if(Helper::getAllProductFromCart())
                                @foreach(Helper::getAllProductFromCart() as $key=>$cart)
                                    <tr>
                                        ...
                                        <td class="product-des" data-title="Deksripsi">
                            ...
                            @else
                                <tr>
                                    <td class="text-center">
                                        Tidak ada gerobak yang tersedia. <a href="{{route('product-grids')}}"
                                                                            style="color:blue;">Lanjut Berbelanja</a>
                                    </td>
                                </tr>
                            @endif
                            ...
                            <div class="col-lg-4 col-md-7 col-12">
                                <div class="right">
                                    ...
                                    <div class="button5">
                                        ...
                                        <a href="{{route('product-grids')}}" class="btn">Lanjut Berbelanja</a>
                                    </div>
                                </div>
                            </div>
                        </div>
