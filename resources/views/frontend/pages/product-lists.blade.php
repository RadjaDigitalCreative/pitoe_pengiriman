                    ...
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="shop-sidebar">
                            ...
                            <div class="single-widget range">
                                <h3 class="title">Belanja Sesuai Harga</h3>
                            ...
                            <div class="single-widget recent-post">
                                <h3 class="title">Posting Terbaru</h3>
                            {{-- {{dd($recent_products)}} --}}
                    ...
                    <div class="col-lg-9 col-md-8 col-12">
                        ...
                        @if(count($products))
                            @foreach($products as $product)
                                                        ...
                                                        <div class="button-head">
                                                            <div class="product-action">
                                                                <a data-toggle="modal" data-target="#{{$product->id}}"
                                                                   title="Lihat Cepat" href="#"><i
                                                                        class=" ti-eye"></i><span>Berbelanja Cepat</span></a>
                                                                <a title="Wishlist"
                                                                   href="{{route('add-to-wishlist',$product->slug)}}"
                                                                   class="wishlist" data-id="{{$product->id}}"><i
                                                                        class=" ti-heart "></i><span>Masukkan ke Wishlist</span></a>
                                                            </div>
                                                            <div class="product-action-2">
                                                                <a title="Masukkan ke Keranjang"
                                                                   href="{{route('add-to-cart',$product->slug)}}">Masukkan
                                                                    ke Keranjang</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="list-content">
                                                    <div class="product-content">
                                                        <div class="product-price">
                                                            ...
                                                            <del>{{rupiah($product->price,2)}}</del>
                                                        </div>
                                                        <h3 class="title"><a
                                                    ...
                                                    <a href="{{route('product-detail',$product->slug)}}" class="btn cart"
                                                       data-id="{{$product->id}}">Beli Sekarang!</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @endforeach
                            @else
                                <h4 class="text-warning" style="margin:100px auto;">Tidak ada produk satupun
                                    disini.</h4>
                            @endif
                        </div>
                        <div class="row">
