...
@section('title','PitoeStore || Halaman Blog')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Blog Kanan</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                ...
                                <div class="shop-single-blog">
                                    ...
                                    <div class="content">
                                        ...
                                        <a href="{{route('blog.detail',$post->slug)}}" class="more-btn">Lanjutkan
                                            Baca</a>
                                    </div>
                                </div>
                                <!-- End Single Blog  -->
