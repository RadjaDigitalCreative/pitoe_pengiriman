                            ...
                            <!--/ End Size -->
                                ...
                                <div class="product-buy">
                                    ...
                                    @if($product_detail->sub_cat_info)
                                        <p class="cat mt-1">Sub Kategori :<a
                                ...
                                <div class="nav-main">
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item"><a class="nav-link active" data-toggle="tab"
                                                                href="#description" role="tab">Dekksripsi</a></li>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="comment-review">
                                                        <div class="add-review">
                                                            ...
                                                            <p>Alamat email Anda tidak akan dipublikasikan. Bidang yang
                                                                harus diisi
                                                                ditandai</p>
                                                        </div>
                                                        <h4>Peringkatmu <span class="text-danger">*</span></h4>
                                                        <div class="review-inner">
                                                                        ...
                                                                        <div class="col-lg-12 col-12">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <textarea name="review" rows="6"
                                                                                          placeholder="Silahkan Masukkan Ulasan Anda Terhadap Barang Ini"></textarea>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-12 col-12">
                                                            ...
                                                            @else
                                                                <p class="text-center p-5">
                                                                    Anda Harus to <a href="{{route('login.form')}}"
                                                                                     style="color:rgb(54, 54, 204)">Masuk</a>
                                                                    atau <a style="color:blue"
                                                                            href="{{route('register.form')}}">Daftar</a>
                                                                </p>
                                                                <!--/ End Form -->
                                                            @endauth
                                                        </div>
                                        ...
                                        <div class="button-head">
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#modelExample" title="Quick View"
                                                   href="#"><i class=" ti-eye"></i><span>Belanja Cepat</span></a>
                                                <a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Masukkan kedalam Wishlist</span></a>
                                                <a title="Bandingkan" href="#"><i class="ti-bar-chart-alt"></i><span>Bandingkan Barang Tersebut</span></a>
                                            </div>
