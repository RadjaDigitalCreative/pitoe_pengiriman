...
@section('main-content')
                    ...
                    <div class="col-lg-8 col-12">
                        <div class="form-main">
                            <div class="title">
                                ...
                                @endphp
                                <h4>Dapatkan Info Dari Kami</h4><br>
                                <h3>Tuliskan Kritik dan Saran @auth @else<span style="font-size:12px;"
                                                                               class="text-danger">[Anda harus login terlebih dahulu]</span>@endauth
                                </h3>
                            </div>
    ...
    <div class="map-section">
        <div id="myMap">
            <iframe
                src="https://maps.google.com/maps?q=Jl.%20Cemara%20II%20No.65,%20Sidorejo%20Lor,%20Kec.%20Sidorejo,%20Kota%20Salatiga,%20Jawa%20Tengah%2050742&t=&z=13&ie=UTF8&iwloc=&output=embed"
    ...
    <div class="modal fade" id="error" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="text-warning">Ups, Maaf!</h2>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
