            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="right-content">
                        <ul class="list-main">
                            <li><i class="ti-location-pin"></i> <a href="{{route('order.track')}}">Track Pengiriman</a>
                            </li>
                            {{-- <li><i class="ti-alarm-clock"></i> <a href="#">Daily deal</a></li> --}}
                            @auth
                                @if(Auth::user()->role=='admin')
                                    <li><i class="ti-user"></i> <a href="{{route('admin')}}" target="_blank">Beranda</a>
                                    </li>
                                @else
                                    <li><i class="ti-user"></i> <a href="{{route('user')}}" target="_blank">Pesanan</a>
                                    </li>
                                @endif
                                <li><i class="ti-power-off"></i> <a href="{{route('user.logout')}}">Keluar</a></li>

                            @else
                                <li><i class="ti-power-off"></i><a href="{{route('login.form')}}">Masuk /</a> <a
                                        href="{{route('register.form')}}">Daftar</a></li>
                            @endauth
                        </ul>
                    </div>
                    <!-- End Top Right -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-2 col-md-2 col-12">
                    <!-- Logo -->
                    <div class="logo" style="margin-top: -15px; width: 50%; height: 50%;">
                        @php
                            $settings=DB::table('settings')->get();
                        @endphp
                    ...
                    <div class="search-top">
                        ...
                        <div class="search-top">
                            <form class="search-form">
                                <input type="text" placeholder="Cari Berdasarkan Nama..." name="search">
                            ...
                            @auth
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
                                        ...
                                        <a href="{{route('wishlist')}}">Semua Wishlist</a>
                                    </div>
                                        ...
                                        @foreach(Helper::getAllProductFromWishlist() as $data)
                                            ...
                                            <li>
                                                <a href="{{route('wishlist-delete',$data->id)}}" class="remove"
                                                   title="Hapus Item Ini"><i class="fa fa-remove"></i></a>
                                        ...
                                        @foreach(Helper::getAllProductFromCart() as $data)
                                            ...
                                            <li>
                                                <a href="{{route('cart-delete',$data->id)}}" class="remove"
                                                   title="Hapus Produk Ini"><i class="fa fa-remove"></i></a>
                                                <a class="cart-img" href="#"><img src="{{$photo[0]}}"
                                                                                  alt="{{$photo[0]}}"></a>
                                                <h4><a href="{{route('product-detail',$data->product['slug'])}}"
                                                       target="_blank">{{$data->product['title']}}</a></h4>
